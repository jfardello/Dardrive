...
::
    ...
    optional arguments:
      ...
      -C CATALOG_STORE, --catalog-store CATALOG_STORE
        ...
        --when depends on the --file switch
    
        --jobid depends on the --extract switch
...
::
    ...
    usage: recover [-h] (-f FILE [FILE ...] | -x) -j JOB [-r RPATH] [-i JOBID]
                   [-w WHEN]
    ...
    optional arguments:
      ...
      -f FILE [FILE ...], --file FILE [FILE ...]
                            Files to recover
      -x, --extract         Recover all content
      -j JOB, --job JOB     Specifies the job
      -r RPATH, --rpath RPATH
                            Recover path
      -i JOBID, --jobid JOBID
                            Restores th specified jobid and its dependencies.
      -w WHEN, --when WHEN  Before date (in dar_manager format)
...
::
    ...
    usage: show [-h] [-l] [-j JOB] [-i ID] [-b] [-n NUM] [-t TYPE]
    ...
    optional arguments:
      ...
      -b, --base            When showing files, show only dar archive base
                            (excluding isolated catalogs)
